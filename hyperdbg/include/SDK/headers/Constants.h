...
#define TRANSPARENT_EVADE_MASK_CPUID_BARE_METAL 0x00000020
...
#define TRANSPARENT_EVADE_MASK_VALID   (TRANSPARENT_EVADE_MASK_ALL | TRANSPARENT_EVADE_MASK_CPUID_BARE_METAL)
