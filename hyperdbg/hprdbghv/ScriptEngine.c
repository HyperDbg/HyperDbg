...
// poi
UINT64
ScriptEngineKeywordPoi(PUINT64 Address)
{
    return *Address;
}
...
// hi
WORD
ScriptEngineKeywordHi(PUINT64 Address)
{
...
// low
WORD
ScriptEngineKeywordLow(PUINT64 Address)
{
    QWORD Result = *Address;
...
// db
BYTE
ScriptEngineKeywordDb(PUINT64 Address)
{
    BYTE Result = *Address;
    return Result;
}
...
// dd
WORD
ScriptEngineKeywordDd(PUINT64 Address)
{
    WORD Result = *Address;
    return Result;
}
...
// dw
DWORD
ScriptEngineKeywordDw(PUINT64 Address)
{
...
// dq
QWORD
ScriptEngineKeywordDq(PUINT64 Address)
{
    QWORD Result = *Address;
    return Result;
}
...
UINT64
GetRegValue(PGUEST_REGS GuestRegs, PSYMBOL Symbol)
{
    switch (Symbol->Value)
    {
    case RAX_MNEMONIC:
...
UINT64
GetPseudoRegValue(PSYMBOL Symbol)
{
    switch (Symbol->Value)
    {
    case TID_MNEMONIC:
...
UINT64
GetValue(PGUEST_REGS GuestRegs, PSYMBOL Symbol)
{
    switch (Symbol->Type)
    {
    case SYMBOL_ID_TYPE:
...
VOID
SetValue(PGUEST_REGS GuestRegs, PSYMBOL Symbol, UINT64 Value)
{
    switch (Symbol->Type)
    {
    case SYMBOL_ID_TYPE:
...
//
VOID
ScriptEngineExecute(PGUEST_REGS GuestRegs, PSYMBOL_BUFFER CodeBuffer, int *Indx)
{
    PSYMBOL Operator;
    PSYMBOL Src0;
    PSYMBOL Src1;
