...
typedef enum _RESOURCE_CONTROLLER_TYPE
{
    ...
    //
    RESOURCE_CONTROLER_TYPE_RDTSC_EXITING,
    RESOURCE_CONTROLER_TYPE_RDPMC_EXITING,
    RESOURCE_CONTROLER_EXTERNAL_INTERRUPT_EXITING,
    RESOURCE_CONTROLER_MOV_TO_DEBUG_REGISTERS_EXITING,
    RESOURCE_CONTROLER_MOV_TO_CR3_EXITING,
