...
#define VMCALL_TEST                                   0x1  // VMCALL to test hypervisor
#define VMCALL_VMXOFF                                 0x2  // VMCALL to Call VMXOFF to turn off the hypervisor
...
#define VMCALL_SET_HIDDEN_CC_BREAKPOINT               0x12 // VMCALL to put hidden breakpoints (using EPT)
#define VMCALL_ENABLE_BREAKPOINT_ON_EXCEPTION_BITMAP  0x13 // VMCALL to enable breakpoints on exception bitmaps
#define VMCALL_DISABLE_BREAKPOINT_ON_EXCEPTION_BITMAP 0x14 // VMCALL to disablee breakpoints on exception bitmaps
