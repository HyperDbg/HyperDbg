...
__declspec(dllexport) BOOLEAN SymShowDataBasedOnSymbolTypes(const char * TypeName, UINT64 Address, PVOID BufferAddress, char * AdditionalParameters, UINT32 AdditionalParametersSize);
