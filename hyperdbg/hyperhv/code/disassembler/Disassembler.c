...
/**
 * @brief Disassembler operand width
 * @details if you want to call it directly, shouldn't not be in VMX-root mode, otherwise, you can
 * call DisassemblerOperandWidthInVmxRootOnTargetProcess to access memory safely
 *
 * @param Address
 * @param Is32Bit
 *
...
DisassemblerOperandWidth(PVOID Address, BOOLEAN Is32Bit)
{
                                            ...
                                            Operands)) != ZYDIS_STATUS_NO_MORE_DATA)
    {
        ...
        //
        // This is a operand width, so just return it
        //
...
/**
 * @brief Disassembler operand width disassembler engine
 * @details Should be called in VMX-root mode
 *
 * @param Address
 * @param Is32Bit
...
DisassemblerOperandWidthInVmxRootOnTargetProcess(PVOID Address, BOOLEAN Is32Bit)
{
    ...
    return DisassemblerOperandWidth(SafeMemoryToRead, Is32Bit);
}
