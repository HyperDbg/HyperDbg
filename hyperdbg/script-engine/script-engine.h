...
__declspec(dllimport) BOOLEAN SymShowDataBasedOnSymbolTypes(const char * TypeName, UINT64 Address, PVOID BufferAddress, char * AdditionalParameters, UINT32 AdditionalParametersSize);
...
__declspec(dllexport) BOOLEAN
    ScriptEngineShowDataBasedOnSymbolTypes(const char * TypeName, UINT64 Address, PVOID BufferAddress, char * AdditionalParameters, UINT32 AdditionalParametersSize);
