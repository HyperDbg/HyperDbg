...
VOID InitializeCommandsDictionary() {
  ...
  g_CommandList[".cls"] = {&CommandClearScreen, &CommandClearScreenHelp,
                           DEBUGGER_COMMAND_CLEAR_ATTRIBUTES};
  g_CommandList["cls"] = {&CommandClearScreen, &CommandClearScreenHelp,
                          DEBUGGER_COMMAND_CLEAR_ATTRIBUTES};

  g_CommandList[".connect"] = {&CommandConnect, &CommandConnectHelp,
                               DEBUGGER_COMMAND_CONNECT_ATTRIBUTES};
  g_CommandList["connect"] = {&CommandConnect, &CommandConnectHelp,
                              DEBUGGER_COMMAND_CONNECT_ATTRIBUTES};

  g_CommandList[".listen"] = {&CommandListen, &CommandListenHelp,
                              DEBUGGER_COMMAND_LISTEN_ATTRIBUTES};
  g_CommandList["listen"] = {&CommandListen, &CommandListenHelp,
                             DEBUGGER_COMMAND_LISTEN_ATTRIBUTES};

  g_CommandList["g"] = {&CommandG, &CommandGHelp,
                        DEBUGGER_COMMAND_G_ATTRIBUTES};
  g_CommandList["go"] = {&CommandG, &CommandGHelp,
                         DEBUGGER_COMMAND_G_ATTRIBUTES};

  g_CommandList[".attach"] = {&CommandAttach, &CommandAttachHelp,
                              DEBUGGER_COMMAND_ATTACH_ATTRIBUTES};
  g_CommandList["attach"] = {&CommandAttach, &CommandAttachHelp,
                             DEBUGGER_COMMAND_ATTACH_ATTRIBUTES};

  g_CommandList[".detach"] = {&CommandDetach, &CommandDetachHelp,
                              DEBUGGER_COMMAND_DETACH_ATTRIBUTES};
  g_CommandList["detach"] = {&CommandDetach, &CommandDetachHelp,
                             DEBUGGER_COMMAND_DETACH_ATTRIBUTES};

  g_CommandList[".process"] = {&CommandProcess, &CommandProcessHelp,
                               DEBUGGER_COMMAND_PROCESS_ATTRIBUTES};

  g_CommandList["sleep"] = {&CommandSleep, &CommandSleepHelp,
                            DEBUGGER_COMMAND_SLEEP_ATTRIBUTES};

  g_CommandList["event"] = {&CommandEvents, &CommandEventsHelp,
                            DEBUGGER_COMMAND_EVENTS_ATTRIBUTES};
  g_CommandList["events"] = {&CommandEvents, &CommandEventsHelp,
                             DEBUGGER_COMMAND_EVENTS_ATTRIBUTES};

  g_CommandList["setting"] = {&CommandSettings, &CommandSettingsHelp,
                              DEBUGGER_COMMAND_SETTINGS_ATTRIBUTES};
  g_CommandList["settings"] = {&CommandSettings, &CommandSettingsHelp,
                               DEBUGGER_COMMAND_SETTINGS_ATTRIBUTES};
  ...
  g_CommandList[".debug"] = {&CommandDebug, &CommandDebugHelp,
                             DEBUGGER_COMMAND_DEBUG_ATTRIBUTES};
  g_CommandList["debug"] = {&CommandDebug, &CommandDebugHelp,
                            DEBUGGER_COMMAND_DEBUG_ATTRIBUTES};

  g_CommandList[".status"] = {&CommandStatus, &CommandStatusHelp,
                              DEBUGGER_COMMAND_DOT_STATUS_ATTRIBUTES};
  g_CommandList["status"] = {&CommandStatus, &CommandStatusHelp,
                             DEBUGGER_COMMAND_STATUS_ATTRIBUTES};

  g_CommandList["load"] = {&CommandLoad, &CommandLoadHelp,
                           DEBUGGER_COMMAND_LOAD_ATTRIBUTES};

  g_CommandList["exit"] = {&CommandExit, &CommandExitHelp,
                           DEBUGGER_COMMAND_EXIT_ATTRIBUTES};
  g_CommandList[".exit"] = {&CommandExit, &CommandExitHelp,
                            DEBUGGER_COMMAND_EXIT_ATTRIBUTES};

  g_CommandList["flush"] = {&CommandFlush, &CommandFlushHelp,
                            DEBUGGER_COMMAND_FLUSH_ATTRIBUTES};

  g_CommandList["pause"] = {&CommandPause, &CommandPauseHelp,
                            DEBUGGER_COMMAND_PAUSE_ATTRIBUTES};

  g_CommandList["unload"] = {&CommandUnload, &CommandUnloadHelp,
                             DEBUGGER_COMMAND_UNLOAD_ATTRIBUTES};

  g_CommandList[".script"] = {&CommandScript, &CommandScriptHelp,
                              DEBUGGER_COMMAND_SCRIPT_ATTRIBUTES};

  g_CommandList["output"] = {&CommandOutput, &CommandOutputHelp,
                             DEBUGGER_COMMAND_OUTPUT_ATTRIBUTES};

  g_CommandList["print"] = {&CommandPrint, &CommandPrintHelp,
                            DEBUGGER_COMMAND_PRINT_ATTRIBUTES};

  g_CommandList["?"] = {&CommandEval, &CommandEvalHelp,
                        DEBUGGER_COMMAND_EVAL_ATTRIBUTES};
  g_CommandList["eval"] = {&CommandEval, &CommandEvalHelp,
                           DEBUGGER_COMMAND_EVAL_ATTRIBUTES};
  g_CommandList["evaluate"] = {&CommandEval, &CommandEvalHelp,
                               DEBUGGER_COMMAND_EVAL_ATTRIBUTES};

  g_CommandList[".logopen"] = {&CommandLogopen, &CommandLogopenHelp,
                               DEBUGGER_COMMAND_LOGOPEN_ATTRIBUTES};

  g_CommandList[".logclose"] = {&CommandLogclose, &CommandLogcloseHelp,
                                DEBUGGER_COMMAND_LOGCLOSE_ATTRIBUTES};

  g_CommandList["test"] = {&CommandTest, &CommandTestHelp,
                           DEBUGGER_COMMAND_TEST_ATTRIBUTES};

  g_CommandList["cpu"] = {&CommandCpu, &CommandCpuHelp,
                          DEBUGGER_COMMAND_CPU_ATTRIBUTES};

  g_CommandList["wrmsr"] = {&CommandWrmsr, &CommandWrmsrHelp,
                            DEBUGGER_COMMAND_WRMSR_ATTRIBUTES};

  g_CommandList["rdmsr"] = {&CommandRdmsr, &CommandRdmsrHelp,
                            DEBUGGER_COMMAND_RDMSR_ATTRIBUTES};

  g_CommandList["!va2pa"] = {&CommandVa2pa, &CommandVa2paHelp,
                             DEBUGGER_COMMAND_VA2PA_ATTRIBUTES};

  g_CommandList["!pa2va"] = {&CommandPa2va, &CommandPa2vaHelp,
                             DEBUGGER_COMMAND_PA2VA_ATTRIBUTES};

  g_CommandList[".formats"] = {&CommandFormats, &CommandFormatsHelp,
                               DEBUGGER_COMMAND_FORMATS_ATTRIBUTES};
  g_CommandList[".format"] = {&CommandFormats, &CommandFormatsHelp,
                              DEBUGGER_COMMAND_FORMATS_ATTRIBUTES};

  g_CommandList["!pte"] = {&CommandPte, &CommandPteHelp,
                           DEBUGGER_COMMAND_PTE_ATTRIBUTES};

  g_CommandList["~"] = {&CommandCore, &CommandCoreHelp,
                        DEBUGGER_COMMAND_CORE_ATTRIBUTES};
  g_CommandList["core"] = {&CommandCore, &CommandCoreHelp,
                           DEBUGGER_COMMAND_CORE_ATTRIBUTES};

  g_CommandList["!monitor"] = {&CommandMonitor, &CommandMonitorHelp,
                               DEBUGGER_COMMAND_MONITOR_ATTRIBUTES};

  g_CommandList["!vmcall"] = {&CommandVmcall, &CommandVmcallHelp,
                              DEBUGGER_COMMAND_VMCALL_ATTRIBUTES};

  g_CommandList["!epthook"] = {&CommandEptHook, &CommandEptHookHelp,
  ...
  g_CommandList["!cpuid"] = {&CommandCpuid, &CommandCpuidHelp,
                             DEBUGGER_COMMAND_CPUID_ATTRIBUTES};

  g_CommandList["!msrread"] = {&CommandMsrread, &CommandMsrreadHelp,
                               DEBUGGER_COMMAND_MSRREAD_ATTRIBUTES};

  g_CommandList["!msrwrite"] = {&CommandMsrwrite, &CommandMsrwriteHelp,
                                DEBUGGER_COMMAND_MSRWRITE_ATTRIBUTES};

  g_CommandList["!tsc"] = {&CommandTsc, &CommandTscHelp,
                           DEBUGGER_COMMAND_TSC_ATTRIBUTES};

  g_CommandList["!pmc"] = {&CommandPmc, &CommandPmcHelp,
                           DEBUGGER_COMMAND_PMC_ATTRIBUTES};

  g_CommandList["!dr"] = {&CommandDr, &CommandDrHelp,
                          DEBUGGER_COMMAND_DR_ATTRIBUTES};

  g_CommandList["!ioin"] = {&CommandIoin, &CommandIoinHelp,
                            DEBUGGER_COMMAND_IOIN_ATTRIBUTES};

  g_CommandList["!ioout"] = {&CommandIoout, &CommandIooutHelp,
  ...
  g_CommandList["!hide"] = {&CommandHide, &CommandHideHelp,
                            DEBUGGER_COMMAND_HIDE_ATTRIBUTES};

  g_CommandList["!unhide"] = {&CommandUnhide, &CommandUnhideHelp,
                              DEBUGGER_COMMAND_UNHIDE_ATTRIBUTES};

  g_CommandList["!measure"] = {&CommandMeasure, &CommandMeasureHelp,
                               DEBUGGER_COMMAND_MEASURE_ATTRIBUTES};

  g_CommandList["lm"] = {&CommandLm, &CommandLmHelp,
                         DEBUGGER_COMMAND_LM_ATTRIBUTES};

  g_CommandList["p"] = {&CommandP, &CommandPHelp,
                        DEBUGGER_COMMAND_P_ATTRIBUTES};
  g_CommandList["pr"] = {&CommandP, &CommandPHelp,
                         DEBUGGER_COMMAND_P_ATTRIBUTES};

  g_CommandList["t"] = {&CommandT, &CommandTHelp,
  ...
  g_CommandList["eb"] = {&CommandEditMemory, &CommandEditMemoryHelp,
                         DEBUGGER_COMMAND_E_ATTRIBUTES};
  g_CommandList["ed"] = {&CommandEditMemory, &CommandEditMemoryHelp,
                         DEBUGGER_COMMAND_E_ATTRIBUTES};
  g_CommandList["eq"] = {&CommandEditMemory, &CommandEditMemoryHelp,
                         DEBUGGER_COMMAND_E_ATTRIBUTES};
  g_CommandList["!eb"] = {&CommandEditMemory, &CommandEditMemoryHelp,
                          DEBUGGER_COMMAND_E_ATTRIBUTES};
  g_CommandList["!ed"] = {&CommandEditMemory, &CommandEditMemoryHelp,
  ...
  g_CommandList["sb"] = {&CommandSearchMemory, &CommandSearchMemoryHelp,
                         DEBUGGER_COMMAND_S_ATTRIBUTES};
  g_CommandList["sd"] = {&CommandSearchMemory, &CommandSearchMemoryHelp,
                         DEBUGGER_COMMAND_S_ATTRIBUTES};
