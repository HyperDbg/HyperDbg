...
/**
 * @brief help of the !mmio command
 *
 * @return VOID
 */
VOID
CommandMmioHelp()
{
    ShowMessages("!mmio : monitors Memory Mapped Input/Output (MMIO) regions.\n\n");

    ShowMessages("syntax : \t!mmio [MemoryType (vapa)] [Attribute (string)] [FromAddress (hex)] "
    ...
    ShowMessages("\n");
    ShowMessages("\t\te.g : !mmio rw fffff801deadb000 fffff801deadbfff\n");
    ShowMessages("\t\te.g : !mmio rw fffff801deadb000 l 1000\n");
    ShowMessages("\t\te.g : !mmio pa rw c01000 l 1000\n");
    ShowMessages("\t\te.g : !mmio rwx fffff801deadb000 fffff801deadbfff\n");
    ShowMessages("\t\te.g : !mmio rwx fffff801deadb000 l 230d0\n");
    ShowMessages("\t\te.g : !mmio rw nt!Kd_DEFAULT_Mask Kd_DEFAULT_Mask+5\n");
    ShowMessages("\t\te.g : !mmio r fffff801deadb000 fffff801deadbfff pid 400\n");
    ShowMessages("\t\te.g : !mmio w fffff801deadb000 fffff801deadbfff core 2 pid 400\n");
    ShowMessages("\t\te.g : !mmio w c01000 c01000+2500 core 2 pid 400\n");
    ShowMessages("\t\te.g : !mmio x fffff801deadb000 fffff801deadbfff core 2 pid 400\n");
    ShowMessages("\t\te.g : !mmio x fffff801deadb000 l 500 core 2 pid 400\n");
    ShowMessages("\t\te.g : !mmio wx fffff801deadb000 fffff801deadbfff core 2 pid 400\n");
    ShowMessages("\t\te.g : !mmio rw fffff801deadb000 l 1000 script { printf(\"read/write occurred at the virtual address: %%llx\\n\", $context); }\n");
    ShowMessages("\t\te.g : !mmio rw fffff801deadb000 l 1000 asm code { nop; nop; nop }\n");
}
