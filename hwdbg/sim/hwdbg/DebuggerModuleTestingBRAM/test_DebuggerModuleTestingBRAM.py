...
def set_input_pins(dut):
    dut.io_outputPin_0.value = 0
    dut.io_outputPin_1.value = 1
    dut.io_outputPin_2.value = 0
    dut.io_outputPin_3.value = 1
    dut.io_outputPin_4.value = 0
    dut.io_outputPin_5.value = 1
    dut.io_outputPin_6.value = 0
    dut.io_outputPin_7.value = 1
    dut.io_outputPin_8.value = 0
    dut.io_outputPin_9.value = 1
    dut.io_outputPin_10.value = 0
    dut.io_outputPin_11.value = 1
    dut.io_outputPin_12.value = 0
    dut.io_outputPin_13.value = 1
    dut.io_outputPin_14.value = 0
    dut.io_outputPin_15.value = 1
    dut.io_outputPin_16.value = 0
    dut.io_outputPin_17.value = 1
    dut.io_outputPin_18.value = 0
    dut.io_outputPin_19.value = 1
    dut.io_outputPin_20.value = 0
    dut.io_outputPin_21.value = 1
    dut.io_outputPin_22.value = 0
    dut.io_outputPin_23.value = 1
    dut.io_outputPin_24.value = 0
    dut.io_outputPin_25.value = 1
    dut.io_outputPin_26.value = 0
    dut.io_outputPin_27.value = 1
    dut.io_outputPin_28.value = 0
    dut.io_outputPin_29.value = 1
    dut.io_outputPin_30.value = 0
    dut.io_outputPin_31.value = 1
