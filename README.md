...
* Running Automated Scripts [<a href="https://docs.hyperdbg.org/using-hyperdbg/kernel-mode-debugging/examples/scripts/running-hyperdbg-script" target="_blank">link</a>][<a href="https://docs.hyperdbg.org/commands/scripting-language/hyperdbg-scripts" target="_blank">link</a>]
