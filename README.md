...
* Cutting-edge Kernel Mode Debugger [<a href="https://docs.hyperdbg.org/using-hyperdbg/kernel-mode-debugging" target="_blank">link</a>][<a href="https://docs.hyperdbg.org/using-hyperdbg/kernel-mode-debugging/examples" target="_blank">link</a>]
...
* Running Automated Scripts [<a href="https://docs.hyperdbg.org/using-hyperdbg/kernel-mode-debugging/examples/scripts/running-hyperdbg-script" target="_blank">link</a>]
